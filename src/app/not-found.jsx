        ...
        <>
            ...
            <div className=" px-5 lg:px-20  py-32 col-span-full grid place-items-center">
                <div className="flex flex-col items-center max-w-[642px] ">
                    ...
                    <Link href='/' className='h-[3rem] grid place-items-center bg-black text-base text-white px-5 mt-5 rounded-md dark:bg-white dark:text-black'>Go to Home Page</Link>
                </div>
            </div>
        </>
    )
