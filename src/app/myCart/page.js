        ...
        <>
            <div className="md:p-10 p-4">
                ...
                <div className="flex gap-6 md:flex-row flex-col">
                    ...
                    <thead>
                        <tr>
                            <th className="py-4 px-6 border-b border-grey3 text-black-500 text-base font-normal text-start">
                            Item
                            </th>
                            <th className="py-4 px-6 border-b border-grey3 text-black-500 text-base font-normal text-start">
                            Price
                    ...
                    <tbody className="px-4">
                        <tr>
                            <td className="p-6 pb-9 border-b border-grey3 align-top">
                                <div className="flex gap-6 items-start md:flex-row flex-col">
                                    <img src="/img/checkList-product1.svg" />
                                    <h3 className="text-base font-normal text-black-500">SAMSUNG 75" Class CU7000000 Crystal UHD 4K Smart TV UN757000FXZAZXCVBNM</h3>
                                </div>
                            </td>
                            <td className="p-6 pb-9 border-b border-grey3 align-top">
                           ...
                           <td className="p-6 pb-9 border-b border-grey3 align-top">
                            <div>
                                ...
                                <button className="flex items-center gap-1 text-sm font-normal text-black-500 mt-[77px]">
                        ...
                        <div className="p-6 pb-9 grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-4 gap-6">
                            <div className="align-top">
                                <div className="flex gap-6 items-center sm:items-start md:flex-row flex-col">
                                    <img src="/img/checkList-product1.svg" />
                                    <h3 className="text-base font-normal text-black-500 line-clamp-3 break-words">SAMSUNG 75" Class CU7000000 Crystal UHD 4K Smart TV UN757000FXZAZXCVBNM</h3>
