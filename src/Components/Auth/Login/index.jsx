  ...
  const handleLogin=()=>{
    ...
    setValidCheck(1)
      if(email !==""&&password !==""){
        ...
        postGraphQl(GET_POSTS_LOGIN_QUERY,inputdata,"login")
                        ...
                        <div className="p-4">
                            <div className="w-full max-w-[534px]">
                                ...
                                <div className="mb-6 flex flex-col gap-2">
                                    ...
                                    <input type="text" onChange={(e)=>setEmail(e.target.value)} className="border-grey3 rounded-lg h-[52px] placeholder:text-grey px-3 py-4 focus:border-grey3 focus:shadow-none focus:ring-0 text-black-500" placeholder="Enter Email Id" />
                                ...
                                <div className="mb-6 flex flex-col gap-2">
                                    ...
                                    <input onChange={(e)=>setPassword(e.target.value)} type="text" className="border-grey3 rounded-lg h-[52px] placeholder:text-grey px-3 py-4 focus:border-grey3 focus:shadow-none focus:ring-0 text-black-500" placeholder="Enter Password" />
                    ...
                    <div className="w-full md:w-[20%]">
                        <div className="border border-grey3 rounded ">
                            <div className="p-4 border-b border-grey3 flex justify-between items-center">
                                ...
                                <p className="text-3-light text-xs font-normal">Edit</p>
                            </div>
                            <div className="p-4">
