          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pb-8 border-b border-grey mb-6">
                  ...
                  <div className=" grid place-items-center  rounded-5 overflow-hidden relative">
                    <div className="flex gap-3 absolute top-2 right-2">
                      <a
                        ...
                        onClick={() =>
                          handleVideo(productDetail?.productYoutubePath)
                        }
                        class="grid place-items-center  col-span-2 cursor-pointer"
                      >
                        <img src="/img/zoom-product.svg" alt="view product" />
                    ...
                    <div className="w-full ">
                      <ReactPlayer
                        url={productDetail?.productYoutubePath}
                        height={160}
                        width={260}
                        controls
                      />
            ...
            <div className="block">
              ...
              <div className="flex gap-2 items-center  mt-4">
                <strong
                  className="flex gap-1 items-center text-2xl font-medium leading-7 text-black 
                ...
                <a className="flex items-center gap-2 min-w-20  min-h-9 w-fit justify-center rounded-5 ">
                  ...
                  >
                    {quantityList().map((data, index) => (
                      <option value={data} className="cursor-pointer	py-4 px-3">
                        {" "}
                        Qty {data}
                      </option>
                    ))}
              ...
              <div className="flex flex-col gap-4 my-6 border-b border-grey"></div>
            </div>
          </div>
